...
namespace Task1
{
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            {
                new student() { firstname = "Nikhil", lastname = "Prasad", smailid = "nikhil@gmailcom", branch = "EE", percentage = 87,skills=new List<string>{"SQL","PHP" } },
                new student() { firstname = "Kunal", lastname = "Zade", smailid = "kunal@gmailcom", branch = "CS", percentage = 89,skills = new List<string>{ "Python"} },
                new student() { firstname = "Tejas", lastname = "Ingole", smailid = "tejas@gmailcom", branch = "ME", percentage = 85,skills = new List<string>{"Java" }},
                new student() { firstname = "Mohammad", lastname = "Kazi", smailid = "mohammad@gmailcom", branch = "ME", percentage = 93,skills = new List<string>{"MySQL" } },
                new student() { firstname = "Yamini", lastname = "Chawre", smailid = "yamini@gmailcom", branch = "CS", percentage = 90,skills = new List<string>{".NET","SQL" } },
                new student() { firstname = "Shruti", lastname = "Lokhande", smailid = "shruti@gmailcom", branch = "EE", percentage = 88,skills = new List<string>{ "ASP.NET"} }
            };
            ...
            var query17 = (from i in Slist where i.lastname == "Prasad" select i).FirstOrDefault();
            ...
            var query18 = (from i in Slist where i.lastname == "Lokhande" select i).Last();
            ...
            var query19 = (from i in Slist where i.lastname == "Chawre" select i).LastOrDefault();
            ...
            var query20 = (from i in Slist where i.lastname == "Zade" select i).Single();
            ...
            var query21 = (from i in Slist where i.lastname == "Ingole" select i).SingleOrDefault();
